...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.xs.sw.veh";
    private static final String ARTIFACT_ID = "vehias";
    private static final String PACKAGE_NAME = "com.xs.sw.veh";
    private static final String TITLE = "车辆检测后端管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.xs.sw.veh";
        String artifactIdNew = "vehias";
        String packageNameNew = "com.xs.sw.veh";
        String titleNew = "车辆检测后端管理系统";
