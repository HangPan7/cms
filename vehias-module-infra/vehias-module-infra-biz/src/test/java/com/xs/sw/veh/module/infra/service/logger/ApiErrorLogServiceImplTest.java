package com.xs.sw.veh.module.infra.service.logger;
...
import com.xs.sw.veh.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import com.xs.sw.veh.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.xs.sw.veh.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.xs.sw.veh.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.xs.sw.veh.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.xs.sw.veh.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.xs.sw.veh.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("vehias-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("vehias-test");
