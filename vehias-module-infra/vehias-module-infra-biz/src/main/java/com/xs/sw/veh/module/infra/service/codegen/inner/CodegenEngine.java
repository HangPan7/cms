package com.xs.sw.veh.module.infra.service.codegen.inner;
...
import com.xs.sw.veh.framework.common.exception.util.ServiceExceptionUtil;
...
import com.xs.sw.veh.framework.excel.core.annotations.DictFormat;
import com.xs.sw.veh.framework.excel.core.convert.DictConvert;
...
import com.xs.sw.veh.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "vehias-module-${table.moduleName}/" + // 顶级模块
                "vehias-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "vehias-module-${table.moduleName}/" + // 顶级模块
                "vehias-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "vehias-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "vehias-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
