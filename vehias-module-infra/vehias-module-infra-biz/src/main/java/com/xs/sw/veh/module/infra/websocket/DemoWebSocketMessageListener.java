package com.xs.sw.veh.module.infra.websocket;
...
import com.xs.sw.veh.framework.websocket.core.sender.WebSocketMessageSender;
import com.xs.sw.veh.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.xs.sw.veh.module.infra.websocket.message.DemoReceiveMessage;
import com.xs.sw.veh.module.infra.websocket.message.DemoSendMessage;
