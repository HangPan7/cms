package com.xs.sw.veh.module.member.service.user;
...
import com.xs.sw.veh.module.member.controller.admin.user.vo.MemberUserPageReqVO;
import com.xs.sw.veh.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import com.xs.sw.veh.module.member.controller.app.user.vo.AppMemberUserResetPasswordReqVO;
import com.xs.sw.veh.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
import com.xs.sw.veh.module.member.controller.app.user.vo.AppMemberUserUpdatePasswordReqVO;
import com.xs.sw.veh.module.member.controller.app.user.vo.AppMemberUserUpdateReqVO;
import com.xs.sw.veh.module.member.convert.auth.AuthConvert;
import com.xs.sw.veh.module.member.convert.user.MemberUserConvert;
import com.xs.sw.veh.module.member.dal.dataobject.user.MemberUserDO;
import com.xs.sw.veh.module.member.dal.mysql.user.MemberUserMapper;
import com.xs.sw.veh.module.member.mq.producer.user.MemberUserProducer;
import com.xs.sw.veh.module.system.api.sms.SmsCodeApi;
import com.xs.sw.veh.module.system.api.sms.dto.code.SmsCodeUseReqDTO;
