package com.xs.sw.veh.module.pay.service.refund;

import cn.hutool.extra.spring.SpringUtil;
import com.xs.sw.veh.framework.common.pojo.PageResult;
import com.xs.sw.veh.framework.pay.core.client.PayClient;
import com.xs.sw.veh.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import com.xs.sw.veh.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.xs.sw.veh.framework.pay.core.enums.channel.PayChannelEnum;
import com.xs.sw.veh.framework.pay.core.enums.refund.PayRefundStatusRespEnum;
import com.xs.sw.veh.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.xs.sw.veh.module.pay.api.refund.dto.PayRefundCreateReqDTO;
import com.xs.sw.veh.module.pay.controller.admin.refund.vo.PayRefundExportReqVO;
import com.xs.sw.veh.module.pay.controller.admin.refund.vo.PayRefundPageReqVO;
...
import com.xs.sw.veh.module.pay.dal.dataobject.refund.PayRefundDO;
import com.xs.sw.veh.module.pay.dal.mysql.refund.PayRefundMapper;
import com.xs.sw.veh.module.pay.dal.redis.no.PayNoRedisDAO;
import com.xs.sw.veh.module.pay.enums.notify.PayNotifyTypeEnum;
import com.xs.sw.veh.module.pay.enums.order.PayOrderStatusEnum;
import com.xs.sw.veh.module.pay.enums.refund.PayRefundStatusEnum;
import com.xs.sw.veh.module.pay.framework.pay.config.PayProperties;
import com.xs.sw.veh.module.pay.service.app.PayAppService;
import com.xs.sw.veh.module.pay.service.channel.PayChannelService;
...
import static com.xs.sw.veh.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.xs.sw.veh.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.xs.sw.veh.framework.common.util.json.JsonUtils.toJsonString;
import static com.xs.sw.veh.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.xs.sw.veh.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.xs.sw.veh.framework.test.core.util.AssertUtils.assertServiceException;
import static com.xs.sw.veh.framework.test.core.util.RandomUtils.randomPojo;
import static com.xs.sw.veh.framework.test.core.util.RandomUtils.randomString;
import static com.xs.sw.veh.module.pay.enums.ErrorCodeConstants.*;
