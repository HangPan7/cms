...
import com.xs.sw.veh.module.system.controller.admin.dept.vo.dept.DeptRespVO;
...
public class DeptController {
    ...
    @Operation(summary = "用部门名称获取部门")
    @Parameter(name = "name", description = "部门名称", required = true, example = "xiaoa")
    @PreAuthorize("@ss.hasPermission('system:dept:query')")
