package com.xs.sw.veh.module.system.controller.admin.logger.vo.operatelog;
...
import com.xs.sw.veh.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.xs.sw.veh.adminserver.UserController.save(...)")
