package com.xs.sw.veh.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.xs.sw.veh.framework.common.enums.CommonStatusEnum;
import com.xs.sw.veh.framework.common.exception.ServiceException;
import com.xs.sw.veh.framework.common.pojo.PageResult;
import com.xs.sw.veh.framework.common.util.collection.ArrayUtils;
...
import com.xs.sw.veh.module.infra.api.file.FileApi;
import com.xs.sw.veh.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.xs.sw.veh.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.xs.sw.veh.module.system.controller.admin.user.vo.user.*;
...
import com.xs.sw.veh.module.system.dal.dataobject.dept.UserPostDO;
...
import com.xs.sw.veh.module.system.dal.mysql.dept.UserPostMapper;
import com.xs.sw.veh.module.system.dal.mysql.user.AdminUserMapper;
import com.xs.sw.veh.module.system.enums.common.SexEnum;
import com.xs.sw.veh.module.system.service.dept.DeptService;
import com.xs.sw.veh.module.system.service.dept.PostService;
import com.xs.sw.veh.module.system.service.permission.PermissionService;
import com.xs.sw.veh.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("vehiasyuanma");
        ...
        assertEquals("vehiasyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("vehiasyuanma"))).thenReturn("java");
