...
import com.xs.sw.veh.framework.sms.config.VehiasSmsAutoConfiguration;
import com.xs.sw.veh.module.system.test.BaseDbAndRedisIntegrationTest;
...
// TODO @芋艿：需要迁移
@Import({VehiasSmsAutoConfiguration.class,
