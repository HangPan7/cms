package com.xs.sw.veh.ssodemo.client;

import com.xs.sw.veh.ssodemo.client.dto.CommonResult;
import com.xs.sw.veh.ssodemo.client.dto.user.UserInfoRespDTO;
import com.xs.sw.veh.ssodemo.client.dto.user.UserUpdateReqDTO;
