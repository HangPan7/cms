...
import com.xs.sw.veh.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.xs.sw.veh.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.xs.sw.veh.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import com.xs.sw.veh.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import com.xs.sw.veh.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static com.xs.sw.veh.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.xs.sw.veh.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.xs.sw.veh.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.xs.sw.veh.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
