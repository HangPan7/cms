package com.xs.sw.veh.module.product.service.category;

import com.xs.sw.veh.framework.common.enums.CommonStatusEnum;
import com.xs.sw.veh.framework.test.core.ut.BaseDbUnitTest;
import com.xs.sw.veh.module.product.controller.admin.category.vo.ProductCategoryCreateReqVO;
import com.xs.sw.veh.module.product.controller.admin.category.vo.ProductCategoryListReqVO;
import com.xs.sw.veh.module.product.controller.admin.category.vo.ProductCategoryUpdateReqVO;
import com.xs.sw.veh.module.product.dal.dataobject.category.ProductCategoryDO;
import com.xs.sw.veh.module.product.dal.mysql.category.ProductCategoryMapper;
...
import static com.xs.sw.veh.module.product.dal.dataobject.category.ProductCategoryDO.PARENT_ID_NULL;
import static com.xs.sw.veh.module.product.enums.ErrorCodeConstants.CATEGORY_NOT_EXISTS;
