package com.xs.sw.veh.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import com.xs.sw.veh.framework.common.pojo.PageResult;
import com.xs.sw.veh.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.xs.sw.veh.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.xs.sw.veh.module.mp.convert.message.MpMessageConvert;
import com.xs.sw.veh.module.mp.dal.dataobject.account.MpAccountDO;
import com.xs.sw.veh.module.mp.dal.dataobject.message.MpMessageDO;
import com.xs.sw.veh.module.mp.dal.dataobject.user.MpUserDO;
import com.xs.sw.veh.module.mp.dal.mysql.message.MpMessageMapper;
import com.xs.sw.veh.module.mp.enums.message.MpMessageSendFromEnum;
import com.xs.sw.veh.module.mp.framework.mp.core.MpServiceFactory;
import com.xs.sw.veh.module.mp.framework.mp.core.util.MpUtils;
import com.xs.sw.veh.module.mp.service.account.MpAccountService;
import com.xs.sw.veh.module.mp.service.material.MpMaterialService;
import com.xs.sw.veh.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.xs.sw.veh.module.mp.service.user.MpUserService;
...
import static com.xs.sw.veh.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
