package com.xs.sw.veh.framework.tracer.config;

import com.xs.sw.veh.framework.common.enums.WebFilterOrderEnum;
import com.xs.sw.veh.framework.tracer.core.aop.BizTraceAspect;
import com.xs.sw.veh.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "vehias.tracer", value = "enable", matchIfMissing = true)
public class VehiasTracerAutoConfiguration {
