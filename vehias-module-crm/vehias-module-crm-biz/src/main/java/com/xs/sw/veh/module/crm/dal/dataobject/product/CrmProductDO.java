package com.xs.sw.veh.module.crm.dal.dataobject.product;

import com.xs.sw.veh.framework.mybatis.core.dataobject.BaseDO;
import com.xs.sw.veh.module.crm.enums.product.CrmProductStatusEnum;
...
public class CrmProductDO extends BaseDO {
     ...
     * 单位
     *
     * 字典 {@link com.xs.sw.veh.module.crm.enums.DictTypeConstants#CRM_PRODUCT_UNIT}
     */
