package com.xs.sw.veh.module.crm.controller.admin.contact.vo;

import com.xs.sw.veh.framework.common.validation.Mobile;
import com.xs.sw.veh.framework.common.validation.Telephone;
...
import com.xs.sw.veh.module.infra.enums.DictTypeConstants;
...
import static com.xs.sw.veh.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY;
...
public class CrmContactBaseVO {
    ...
    @DictFormat(com.xs.sw.veh.module.system.enums.DictTypeConstants.USER_SEX)
